...
public class StackedColumnSeriesRenderBaseElement extends CartesianChartElement {
	...
	protected function drawWireOfColumnStacks(x:int,
											  y:int,
											  data1:Object,
											  data2:Object,
											  v1:Number,
	...
	protected function drawColumnOverHead(rect:Rectangle, data:Object):void {
		...
		graphics.drawRect(rect.x, rect.y - 50, rect.width, 50);
		graphics.drawRect(rect.x + border, rect.y - 50 + border, rect.width - (border * 2), 50 - (border * 2));
		graphics.endFill();
	}
}
}
